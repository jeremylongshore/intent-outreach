 ...
 */
export async function runArvOnce() {
 ...
 */
function checkTenantDocument(tenantId, tenantData) {
 ...
 */
async function checkTenantSecrets(tenantId) {
 ...
 */
async function checkFunctionReachability(tenantId) {
 ...
 */
async function checkVertexPath(tenantId) {
 ...
 */
async function writeArvResult(result) {
